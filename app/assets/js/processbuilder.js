...
class ProcessBuilder {
    ...
    _constructJVMArguments112(mods, tempNativePath){
        ...
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=TheSiteLauncher')
    ...
    _constructJVMArguments113(mods, tempNativePath){
        ...
        args.push('-Dorg.lwjgl.util.Debug=true')
        args.push('-Dorg.lwjgl.util.DebugLoader=true')
                ...
                if(argDiscovery.test(args[i])){
                    ...
                    switch(identifier){
                        ...
                        case 'natives_directory':
                            ...
                            break
                        case 'launcher_name':
                            val = args[i].replace(argDiscovery, 'The-Site-Launcher')
                            break
